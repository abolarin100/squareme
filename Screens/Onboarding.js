  ...
  return (
    ...
    <View className="flex-1 ">
      ...
      >
        ...
        <View className=" flex-1 flex-row pt-4 pl-8">
      ...
      <View className=' flex-1 flex-col px-8 my-16 justify-end gap-4  '>
        <View>
          <Image
            source={require("../assets/images/grp1.png")}
            className=""
          />
        </View>

        <View className=''>
          <Text className=' text-3xl text-white font-semibold font-Dms'>Fast and easy payments to anyone .</Text>
        </View>
        <View>
          <Text className='text-sm text-white '>Receive funds sent to you in seconds.</Text>
        </View>
      </View>


      <View className='flex-row justify-between px-8 py-8 '>
