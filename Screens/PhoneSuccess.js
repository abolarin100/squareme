            ...
            <SafeAreaView className='flex-1'>
                <View className=" flex-1 flex-col justify-start  gap-1  w-[100%]  ">
                    ...
                    <View className=' flex-col  items-center  '>
                        <Text className='text-xl font-bold text-center w-[80%] text-black'>Verification Successful</Text>
                        <Text className='text-sm text-center w-[100%] text-[#4D4D4D] mt-6 '>Your phone number has been verified successfully.</Text>
                    </View>
